...
mod tests {
    ...
    #[test]
    fn test_ssz_value_extraction_capella() {
        // Load get_header JSON from test data
        let json_bytes = include_bytes!("../../../../tests/data/get_header/capella.json");
        let decoded = decode_json_payload_orig(json_bytes).expect("failed to decode JSON");

        // Encode as SSZ
        let encoded = decoded.data.as_ssz_bytes();

        // Extract the bid value from the SSZ
        let bid_value = get_bid_value_from_signed_builder_bid_ssz(&encoded, ForkName::Capella)
    ...
    #[test]
    fn test_ssz_value_extraction_deneb() {
        // Load get_header JSON from test data
        let json_bytes = include_bytes!("../../../../tests/data/get_header/deneb.json");
        let decoded = decode_json_payload_orig(json_bytes).expect("failed to decode JSON");
        ...
        // Extract the bid value from the SSZ
        let bid_value = get_bid_value_from_signed_builder_bid_ssz(&encoded, ForkName::Deneb)
            .expect("failed to extract bid value from SSZ");
    ...
    #[test]
    fn test_ssz_value_extraction_electra() {
        // Load get_header JSON from test data
        let json_bytes = include_bytes!("../../../../tests/data/get_header/electra.json");
        let decoded = decode_json_payload_orig(json_bytes).expect("failed to decode JSON");
        ...
        // Extract the bid value from the SSZ
        let bid_value = get_bid_value_from_signed_builder_bid_ssz(&encoded, ForkName::Electra)
            .expect("failed to extract bid value from SSZ");
    ...
    #[test]
    fn test_ssz_value_extraction_fulu() {
        // Load get_header JSON from test data
        ...
        // Extract the bid value from the SSZ
        let bid_value = get_bid_value_from_signed_builder_bid_ssz(&encoded, ForkName::Fulu)
            .expect("failed to extract bid value from SSZ");
