...
use cb_common::{
    ...
    utils::{
        CONSENSUS_VERSION_HEADER, EncodingType, get_accept_types,
        get_bid_value_from_signed_builder_bid_ssz, get_consensus_version_header, get_user_agent,
...
use super::{CompoundGetHeaderResponse, LightGetHeaderResponse};
use crate::{
    constants::{
