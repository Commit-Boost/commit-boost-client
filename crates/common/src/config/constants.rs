...
pub const SIGNER_DIRK_CERT_ENV: &str = "CB_SIGNER_DIRK_CERT_FILE";
pub const SIGNER_DIRK_CERT_DEFAULT: &str = "/certificates/dirk.crt";
pub const SIGNER_DIRK_KEY_ENV: &str = "CB_SIGNER_DIRK_KEY_FILE";
